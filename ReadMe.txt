...
MessageComposer runs on earlier and later releases of the iPhone OS and uses
...
1. Set your iPhone OS Deployment Target setting to your application's target
iPhone OS release
This setting indicates the earliest iPhone OS on which your application can
run. We set it to iPhone OS 3.0.
...
Mac OS X 10.6 or later, Xcode 3.2 or later, iPhone OS 4.0
...
Tap the "Compose Mail" button to display an email composition interface if your device is running iPhone OS 3.0; tap the "Compose SMS" button to display an SMS composition interface if your device is running iPhone OS 4.0. Otherwise display feedback message.
